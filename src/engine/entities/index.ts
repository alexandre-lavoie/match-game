...
export class Entity {
    ...
    public onValueChange(key: string, callback: (value: number) => void, context?: EmitterContext): this {
        return this.callbackWrap("valueChange", (otherKey: string, value: number) => (key === otherKey) && callback(value), context);
    }
    ...
    public onPushPoint(callback: (x: number, y: number) => void, context?: EmitterContext): this {
