...
export class Game {
    ...
    public hasMatch(x: number, y: number, line: Phaser.Types.Math.Vector2Like[]): boolean {
    ...
    private controllerMatch(entity: Entity): boolean {
        ...
        if (match) {
            ...
            this.eventEmitter.emit("game-entity-change", this.entities[this.entityIndex]);
        }
    ...
    public onEntityChange(callback: (entity: Entity) => void, context?: EmitterContext) {
