...
export abstract class GameScene extends Phaser.Scene {
  ...
  protected createVisual() {
    ...
    const enemySprite = this.add.sprite(
      window.innerWidth * enemyPlacement.x,
      window.innerHeight * enemyPlacement.y,
      "enemy"
    );
    ...
    boardRenderer.x =
      window.innerWidth * boardPlacement.x - boardSprite.width / 2;
    boardRenderer.y =
      window.innerHeight * boardPlacement.y - boardSprite.height / 2;
